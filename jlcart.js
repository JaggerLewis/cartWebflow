...
const initAboB = async () => {
    ...
    let active = formula.find((elem) => elem.metadata.pricing == 'monthly').prices[0].metadata.activation == 'false'
    ...
    active = formula.find((elem) => elem.metadata.pricing == 'yearly').prices[0].metadata.activation == 'false'
    ...
    active = formula.find((elem) => elem.metadata.pricing == 'life').prices[0].metadata.activation == 'false'
