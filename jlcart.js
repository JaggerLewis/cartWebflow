...
const initHome = async () => {
    ...
    document.querySelector('#btn-dock-color-fauve').addEventListener('click', (event) => {
        event.preventDefault()
        colorButtonAction(collar, findProduct('jag-smartdock', 'fauve').image, findProduct('jag-smartdock', 'fauve').price.id )
    ...
    document.querySelector('#btn-dock-color-weimar').addEventListener('click', (event) => {
        event.preventDefault()
        colorButtonAction(collar, findProduct('jag-smartdock', 'weimar').image, findProduct('jag-smartdock', 'weimar').price.id )
    ...
    document.querySelector('#btn-dock-color-charbon').addEventListener('click', (event) => {
        event.preventDefault()
        colorButtonAction(collar, findProduct('jag-smartdock', 'charbon').image, findProduct('jag-smartdock', 'charbon').price.id )
...
const initAbonnement = async () => {
    ...
    document.querySelector('#toggle').addEventListener('click', (event) => {
        ...
        if ( document.querySelector('#abo-facture-mois').classList.contains('text-selected')) {
            ...
            document.querySelector('#total-family-premium').innerHTML = "soit <b>" + (findAbonnement("premium-family").prices[0].price / 12).toFixed(2) + '€</b> au mois'
            ...
            document.querySelector('#total-family-premium').innerHTML = "soit <b>" +  findAbonnement("premium-family").prices[1].price * 12 + "€</b> par an"
            document.querySelector('#total-starter-family').innerHTML = "soit <b>" +  findAbonnement("starter-family").prices[1].price * 12 + "€</b> par an"
            document.querySelector('#total-starter').innerHTML = "soit <b>" +  findAbonnement("starter").prices[0].price * 12 + "€</b> par an"
            updateTime(true)
        }
    })
}
